...
// Source: github.com/uber-common/bark (interfaces: Logger)
...
import (
	...
	bark "github.com/uber-common/bark"
	reflect "reflect"
)
...
func (m *MockLogger) Fields() bark.Fields {
	ret := m.ctrl.Call(m, "Fields")
	ret0, _ := ret[0].(bark.Fields)
	return ret0
}
...
func (m *MockLogger) WithError(arg0 error) bark.Logger {
	ret := m.ctrl.Call(m, "WithError", arg0)
	ret0, _ := ret[0].(bark.Logger)
	return ret0
}
...
func (m *MockLogger) WithField(arg0 string, arg1 interface{}) bark.Logger {
...
func (m *MockLogger) WithFields(arg0 bark.LogFields) bark.Logger {
